...
(custom-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight bold :height 75 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
 '(cursor ((t (:background "red"))))
 '(font-lock-function-name-face ((t (:foreground "chartreuse"))))
 '(font-lock-keyword-face ((t (:foreground "orange red"))))
 '(font-lock-type-face ((t (:foreground "#2244FF" :weight ultra-bold))))
